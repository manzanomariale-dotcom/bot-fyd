...
def construir_y_enviar_tabla(rango_minutos_desc):
  ...
  if not slots_activos:
    # Si la memoria está vacía, forzamos un ejemplo falso solo para la prueba manual
...
if __name__ == '__main__':
  # Hilo para las tareas automáticas del reloj
  hilo_schedule = threading.Thread(target=ejecutar_programador)
  hilo_schedule.daemon = True
  hilo_schedule.start()

  # Hilo para que el bot escuche los comandos en Telegram
